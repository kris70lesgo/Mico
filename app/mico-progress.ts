export type MicoProgress={xp:number;hearts:number;streak:number;dailyXp:number;lastActive:string;completed:string[];mastery:Record<string,number>;weak:string[];unlimitedHeartsUntil?:string};
