# Mico Marketing Landing Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Replace the public Mico entry screen with a full marketing landing experience and keep account flows on their own routes.

**Architecture:** `mico-landing.tsx` owns the public section sequence and exposes existing signup, login, and demo callbacks. Its paired stylesheet provides a desktop-first, responsive marketing layout while using local Mico anatomy and mascot assets instead of third-party branding or media.
