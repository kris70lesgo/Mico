# Mico Supabase Foundation Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Give Mico secure personal accounts and durable learner data without allowing a public demo to write into any real learner account.
...
**Files:**
- Create: `supabase/migrations/20260914074121_mico_learning_platform.sql`
...
**Files:**
- Create: `supabase/migrations/20260914075132_mico_shop_rpc.sql`
...
**Files:**
- Create: `app/supabase.ts`, `app/mico-auth.tsx`, `app/mico-auth.css`
- Modify: `app/page.tsx`, `app/mico-sync.ts`, `app/mico-app.tsx`
